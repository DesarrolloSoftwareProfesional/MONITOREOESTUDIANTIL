...
class AlumnoDao
{
    ...
    //funcion para listar alumnos por apoderado

    public function list_alum_by_IDapoderado($idApod)
    {
        $sql = "CALL SP_ALUMNOS_SELECT_BY_IDApoderado(?)";
        return $this->mysqli->find($sql, $idApod);
    }
}
