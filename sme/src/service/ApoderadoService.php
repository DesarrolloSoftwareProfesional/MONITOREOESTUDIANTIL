<?php
    ...
    */
    class ApoderadoService implements iCrudService
    {
        ...
        public function getAllAlumnoByIDApoderado()
        {
            if (!empty($_GET[UtilConst::ID])) {
                UtilService::jsonencode($this->dao->getAllAlumnoByIDApoderado($_GET[UtilConst::ID]));
            } else {
                UtilService::errorResponse("No ingreso codigo de".self::TABLE);
            }
        }
            ...
            if (!empty($_GET[UtilConst::ACCION])) {
                ...
                switch ($action) {
                    ...
                    case 'logeo':
                        $this->logeo();
                        break;
                      case 'alumnoidapoderado':
                        $this->getAllAlumnoByIDApoderado();
                        break;
                    default:
