<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#menu-sme" aria-expanded="false">
    ...
    <!-- COLLAPSIBLE NAVBAR -->
    <div class="collapse navbar-collapse" id="menu-sme">
